...
export type InsertProfileMutation = {
  insert_profiles_one: {
    created_at: any;
    date_of_birth: any;
    gender: Types.Genders_Enum;
...
export type UpdateProfilePreferenceMutation = {
  update_profiles_by_pk: {
    sexuality: Types.Sexuality_Enum | null;
    seeking_relationship: string | null;
    updated_at: any;
...
export type UpdateProfileRelationPreferenceMutation = {
  update_profiles_by_pk: { seeking_relationship: string | null } | null;
};
...
export class UpdateProfileLocationGQL extends Apollo.Mutation<
  UpdateProfileLocationMutation,
  UpdateProfileLocationMutationVariables
> {
...
export class UpdateProfilePreferenceGQL extends Apollo.Mutation<
  UpdateProfilePreferenceMutation,
  UpdateProfilePreferenceMutationVariables
> {
...
export const UpdateProfileRelationPreferenceDocument = /*#__PURE__*/ gql`
  mutation UpdateProfileRelationPreference($id: uuid!, $seeking_relationship: String!) {
    update_profiles_by_pk(pk_columns: { id: $id }, _set: { seeking_relationship: $seeking_relationship }) {
      seeking_relationship
    }
  }
`;
...
export class UpdateProfileRelationPreferenceGQL extends Apollo.Mutation<
  UpdateProfileRelationPreferenceMutation,
  UpdateProfileRelationPreferenceMutationVariables
> {
