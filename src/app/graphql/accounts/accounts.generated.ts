...
export type GetUserQuery = { user: { updatedAt: any, phoneNumberVerified: boolean, phoneNumber: string | null, newEmail: any | null, lastSeen: any | null, emailVerified: boolean, email: any | null, displayName: string, createdAt: any, avatarUrl: string, activeMfaType: string | null, defaultRole: string, disabled: boolean, id: any } | null };
...
export const UpdateUserDisplayNameDocument = /*#__PURE__*/ gql`
  ...
  export class UpdateUserDisplayNameGQL extends Apollo.Mutation<UpdateUserDisplayNameMutation, UpdateUserDisplayNameMutationVariables> {
...
export const UpdateUserAvatarUrlDocument = /*#__PURE__*/ gql`
  ...
  export class UpdateUserAvatarUrlGQL extends Apollo.Mutation<UpdateUserAvatarUrlMutation, UpdateUserAvatarUrlMutationVariables> {
